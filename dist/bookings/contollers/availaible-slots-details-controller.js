...
exports.availaibleSlotsDetailsController = void 0;
...
let availaibleSlotsDetailsController = class availaibleSlotsDetailsController {
    ...
    async getAvailaibleDates(query, productId, authHeader) {
        ...
        return await this.getAvailaibleDatesService.getAvailaibleDates(productId, authHeader);
...
exports.availaibleSlotsDetailsController = availaibleSlotsDetailsController;
__decorate([
...
], availaibleSlotsDetailsController.prototype, "getAvailaibleDates", null);
exports.availaibleSlotsDetailsController = availaibleSlotsDetailsController = __decorate([
    (0, common_1.Controller)("api"),
    __metadata("design:paramtypes", [typeof (_a = typeof get_availaible_dates_service_1.GetAvailaibleSlotsDetailsService !== "undefined" && get_availaible_dates_service_1.GetAvailaibleSlotsDetailsService) === "function" ? _a : Object])
], availaibleSlotsDetailsController);
